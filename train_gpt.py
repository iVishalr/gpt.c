...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_data", type=str, required=True, help="Path to training data generated by `prepro_xxx.py` script.")
    parser.add_argument("--val_data", type=str, default=None, required=False, help="Path to validation data generated by `prepro_xxx.py` script. Default: None")
